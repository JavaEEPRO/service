...
public class AbstractUserEntity extends AbstractNamedEntity {
    ...
    @JoinTable(name = "svc_users_roles", joinColumns = @JoinColumn(name = "user_id", referencedColumnName = "id"), inverseJoinColumns = @JoinColumn(name = "role_id", referencedColumnName = "id"))
