...
import si.inspired.persistence.dao.UserRepository;
import si.inspired.security.CustomRememberMeServices;
import si.inspired.security.google2fa.CustomAuthenticationProvider;
import si.inspired.security.google2fa.CustomWebAuthenticationDetailsSource;
import si.inspired.security.location.DifferentLocationChecker;
import java.io.File;
import java.io.IOException;

@Configuration
@ComponentScan(basePackages = { "si.inspired.security" })
@EnableWebSecurity
